...
#hola, respuuestas dependiendo lo que diga el saludp
        ...
        ['chau', 'hasta luego', 'auf wiederseen', 'Goodbye', 'I am Leaving', 'Have a Good day', 'bye', 'cao', 'see ya'],
        single_response = True)
        ...
        ['what stocks do I own?', 'how are my shares?', 'what companies am I investing in?', 'what am I doing in the markets?'], 
